...
export default function GalleryComponent() {
  ...
  return (
    ...
    <div className="container" >
      ...
      <Slider {...settings}>
        <div><img src={"./images/galleryc1.png"}  style={{ width: '90%' }}  alt='' /></div>
      
    <div> <img src={"./images/galleryc2.png"} style={{ width: '90%' }}  alt='' /></div>
   
      <div>
        <img src={"./images/galleryc3.png"} style={{ width: '90%' }} alt='' />
      </div>
      <div>
      <img src={"./images/galleryc4.png"} style={{ width: '90%' }}  alt='' /> 
      </div>
      <div>
        <img src={"./images/galleryc1.png"} style={{ width: '90%' }}  alt='' />
      </div>
      <div>
        <img src={"./images/galleryc3.png"} style={{ width: '90%' }}  alt='' />
      </div>
